...
import { ProjectsToggleButtonProps } from "@/components/developer-skills/developer-skill/projects-button/types";
...
export const ProjectsToggleButton: React.FC<ProjectsToggleButtonProps> = ({
  ...
  return (
    <div className="flex gap-4 items-center justify-between" onClick={onClick}>
